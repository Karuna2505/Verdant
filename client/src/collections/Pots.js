...
const Pots = () => {
  return (
    <div className='w-full text-[#357b57]'>
        <h1 className='font-medium text-2xl py-4 md:px-20 px-10'>Pots & Planters</h1>
        <p className='pb-4 md:px-20 px-10'>Plant pots are the best way to give your plants a safe and happy home, as well as elevate your home decor game. With Verdant collection of sleek, elegant, and aesthetic pots and planters,  you can give your plants only the best!</p>
  ...
  <h1 className='font-medium sliding-underline'>CLEAR ALL</h1>
        ...
        {/* {plants.map((plant) => (
        <PlantCard key={plant.id} name={plant.name} price={plant.price} url={plant.url}/>
      ))} */}
        </div>
      </div> 
    </div>
